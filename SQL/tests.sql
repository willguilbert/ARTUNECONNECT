...
-- Database: artuneconnecttests : Pour faire des tests, ajouter cette DB dans votre .env.
DROP DATABASE IF EXISTS ARTUNECONNECTTESTS;
CREATE DATABASE IF NOT EXISTS ARTUNECONNECTTESTS;

USE ARTUNECONNECTTESTS;
